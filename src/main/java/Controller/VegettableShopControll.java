 ...
 * @author Trung
 */
@WebServlet(name = "VegettableShopControll", urlPatterns = {"/Vegettable"})
public class VegettableShopControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FilterShopDAO dao = new FilterShopDAO();
        LatestProductDAO daoLP = new LatestProductDAO();
        
        List<Sanpham> listSP = dao.getVegettable();
