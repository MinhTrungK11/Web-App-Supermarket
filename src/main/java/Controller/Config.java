...
public class Config {
    ...
    public static String vnp_Returnurl = "https://webbachhoag11.herokuapp.com/doneorder";
    public static String vnp_TmnCode = "ZPVPL4PT";
    public static String vnp_HashSecret = "PTDOVFAQLHSXCBKLRZIUAOUQGXRUCDKI";
