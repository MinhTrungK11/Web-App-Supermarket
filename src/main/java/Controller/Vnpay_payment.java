...
public class Vnpay_payment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int amount = Math.round(Float.parseFloat(request.getParameter("tongthanhtoan")) * 100);
        ...
        inf.add(email);
        inf.add(maVoucher);
        session.setAttribute("in4order", inf);
        ...
        vnp_Params.put("vnp_Bill_Address", request.getParameter("diachi"));
        ...
        // Invoice
        vnp_Params.put("vnp_Inv_Phone", request.getParameter("sdt"));
        vnp_Params.put("vnp_Inv_Email", request.getParameter("emai"));
        vnp_Params.put("vnp_Inv_Customer", request.getParameter("txt_inv_customer"));
        vnp_Params.put("vnp_Inv_Address", request.getParameter("diachi"));
