 ...
 * @author Trung
 */
@WebServlet(name = "FreshOnionShopControll", urlPatterns = {"/FreshOnion"})
public class FreshOnionShopControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Sanpham> listSP = dao.getFreshOnion();
