...
public class AddVoucher extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (adminAccount == null) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("Admin/add-voucher.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (adminAccount == null) {
            ...
            List<Voucher> lsVoucher = voucherDAO.getVoucher();
            for (Voucher voucher : lsVoucher) {
                if (voucher.getMaVoucher().contains(id)) {
                    request.setAttribute("err", "Mã voucher đã tồn tại. Mời nhập lại!");
                    RequestDispatcher rd = request.getRequestDispatcher("/Admin/add-voucher.jsp");
                    rd.forward(request, response);
                    return;
                }
            ...
            Voucher voucher = new Voucher(id, discount, soluong);
