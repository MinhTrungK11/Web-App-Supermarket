...
public class DetailOrder extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (adminAccount == null) {
            ...
            List<Chitietdonhang> lsChiTiet = donHangDAO.getChiTietDonHangById(idDonHang);
            request.setAttribute("lsChiTiet", lsChiTiet);
            PrintWriter out = response.getWriter();
            for (Chitietdonhang o : lsChiTiet) {
                Sanpham sp = spDao.get1SP(o.getChitietdonhangPK().getIdSanPham());
                String name = sp.getTenSanPham();
                out.println(" <tr>\n"
                        + "                                <td>" + o.getChitietdonhangPK().getIdSanPham() + "</td>\n"
