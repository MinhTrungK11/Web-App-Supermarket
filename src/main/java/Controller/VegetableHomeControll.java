 ...
 * @author Trung
 */
@WebServlet(name = "VegetableControll", urlPatterns = {"/vegetable"})
public class VegetableHomeControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FilterHomeDAO daoSP = new FilterHomeDAO();
        LatestProductDAO daoLP = new LatestProductDAO();
        
        List<Sanpham> listSP = daoSP.getVegettable();
