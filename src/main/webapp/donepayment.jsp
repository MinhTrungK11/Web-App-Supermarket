...
<body>
    ...
    <!-- Header Section End -->
    <h1 style="text-align:center">${ketQua}</h1>
    <c:if test="${ketQua == 'ĐẶT HÀNG THÀNH CÔNG!'}">
        <a href="/orders">
            <div style="text-align:center">
                <button class="site-btn">Đến đơn hàng</button>
            </div>
        </a>
    </c:if>
    <c:if test="${ketQua == 'ĐẶT HÀNG THẤT BẠI!'}">
        <a href="/home">
            <div style="text-align:center">
                <button class="site-btn">Về trang chủ</button>
            </div>
        </a>
    </c:if>
