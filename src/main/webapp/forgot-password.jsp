                    ...
                    <div class="col-lg-8">
                        <nav class="header__menu">
                            <ul>
                                ...
                                <li class="active"><a href="signup">forgot password</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
        ...
        <div class="login-page">
            <div class="form">
                <form class="register-form" action="forgotpassword" method="post">
                    <input value="${email}" name="email" type="email" placeholder="Email" title="Hãy nhập email của bạn, mã xác minh được gửi về địa chỉ mail của bạn" required/>
                    <button name="btnVerify" type="submit">GỬI</button>
