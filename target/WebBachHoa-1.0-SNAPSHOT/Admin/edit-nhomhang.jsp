                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        ...
                        <div class="row tm-edit-product-row middle">
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <form action="EditNhomHang" class="tm-edit-product-form"  method="post">
                                    <div class="form-group mb-3">
                                        <label for="qty">Mã nhóm hàng</label>
                                        <input id="qty" name="id" type="text" class="form-control validate" value="${NhomHang.idNhomHang}" readonly/>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="name">Tên nhóm hàng</label>
                                        <input id="name" name="name" type="text" class="form-control validate text-white" value="${NhomHang.tenNhomHang}" required/>
                                    </div>
                                    <button type="submit" class="btn btn-primary btn-block text-uppercase text-white" onclick="clicked(event)">Cập nhật nhóm hàng</button>
                                </form>
                            </div>
                        </div>
                    </div>
