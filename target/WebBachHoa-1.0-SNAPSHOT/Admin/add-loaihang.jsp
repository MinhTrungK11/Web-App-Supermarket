                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        ...
                        <div class="row tm-edit-product-row middle"">
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <form action="AddLoaiHang" class="tm-edit-product-form"  method="post">
                                    ...
                                    <div>
                                        <button type="submit" class="btn btn-primary btn-block text-uppercase text-white" onclick="clicked(event)">Thêm loại hàng</button>
                                    </div>
                                </form>
                            </div>
                        </div>
