                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        ...
                        <div class="row tm-edit-product middle">
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <form action="AddVoucher" class="tm-edit-product-form"  method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="discount" name="discount" type="number" class="form-control validate" min="0" max="100" required/>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="soLuong">Số lượng</label>
                                        <input id="soLuong" name="soLuong" type="number" class="form-control validate" min="0" required/>
                                    </div>
                                    <div >
                                        <button type="submit" class="btn btn-primary btn-block text-uppercase" onclick="clicked(event)">Thêm Voucher</button>
                                    </div>
                            </div>
                            </form>
                        </div>
