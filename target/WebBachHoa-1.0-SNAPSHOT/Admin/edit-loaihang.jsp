            ...
            <div class="row">
                <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        <div class="row">
                            <div class="col-12">
                                <h2 class="tm-block-title middle">Thông tin loại hàng</h2>
                            </div>
                        </div>
                        <div class="row tm-edit-product-row middle">
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <form action="EditLoaiHang" class="tm-edit-product-form"  method="post">
                                    <div class="form-group mb-3">
                                        <label for="qty">Id</label>
                                        <input id="id" name="id" type="text" class="form-control validate" value="${loaihang.idLoaiHang}" readonly/>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="name">Tên loại hàng</label>
                                        <input id="name" name="name" type="text" class="form-control validate text-white" value="${loaihang.tenLoaiHang}" required/>
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="group"class="custom-select tm-select-accounts" id="group" required>
                                            ...
                                            <c:forEach items="${lsNH}" var="o">
                                                <option value="${o.idNhomHang}" ${loaihang.idNhomHang.idNhomHang == o.idNhomHang ? 'selected' : ''}>${o.tenNhomHang}</option> 
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <button type="submit" class="btn btn-primary btn-block text-uppercase text-white" onclick="clicked(event)">Cập nhật loại hàng</button>
                                </form>
                            </div>
                        </div>
                    </div>
