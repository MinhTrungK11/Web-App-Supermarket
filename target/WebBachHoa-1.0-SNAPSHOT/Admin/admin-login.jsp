...
<%
    ...
    if (adminAccount != null) {
        request.getRequestDispatcher("/Admin/AdminDashboard").forward(request, response);
    }
%>
...
<!--        <link rel="stylesheet" href="css/font-awesome.min.css" type="text/css">-->
    ...
    <body>
                    ...
                    <div class="col-lg-8">
                        <nav class="header__menu">
                            <ul>
                                ...
                                <li class="active"><a href="/Admin/admin-login.jsp">ADMIN LOGIN</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
        ...
        <div class="login-page">
            <div class="form">
                <form class="admin-login-form" action="../AdminLogin" method="post">
